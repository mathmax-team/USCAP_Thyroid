    ...
    dbc.Container(
        [
            html.A(
                ...
                dbc.Row(
                    [
                        dbc.Col(html.Img(src="/assets/logo_IC_nobg.png", height="30px")),
            ...
            html.A(
                ...
                dbc.Row(
                    [
                        dbc.Col(html.Img(src="/assets/logo_IC_nobg.png", height="60px")),
                        # dbc.Col(dbc.NavbarBrand("Logo", className="ms-2")),
                    ],
                    align="center",
                    className="g-0",
...
app.layout = html.Div(
    [logo]#, custom_default]#, logo, search_navbar, dashboard]
,)
