...
def make_scatter_graph_time_bethesda(dataframe):


    graph=px.line(dataframe,x="Year", y="Call Count",color="Category",markers=True, color_discrete_sequence=px.colors.qualitative.T10)
    ...
    graph.update_layout(
                ...
                title={
                "text":"Call Count By Category Over Time",
                'y':0.98,
                'x':0.46,
                'xanchor': 'center',
                'yanchor': 'top'
